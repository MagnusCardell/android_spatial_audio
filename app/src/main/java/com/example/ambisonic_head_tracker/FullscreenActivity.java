...
public class FullscreenActivity extends AppCompatActivity implements SensorEventListener {
    //3D audio renderer
    private String OBJECT_SOUND_FILE = "assets/cube_sound.wav";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean success = gvrAudioEngine.preloadSoundFile(OBJECT_SOUND_FILE);
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mLastAccelerometerSet && mLastMagnetometerSet) {
            ...
            xView.setText(String.valueOf(mR[0]));
            yView.setText(String.valueOf(mR[1]));
            zView.setText(String.valueOf(mR[2]));
        }
    ...
    private void startTracker(Intent intent) {
